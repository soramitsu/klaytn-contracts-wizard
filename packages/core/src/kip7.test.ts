...
// testAPIEquivalence('kip7 API full upgradeable', {
//   name: 'CustomToken',
//   symbol: 'CTK',
//   premint: '2000',
//   access: 'roles',
...
//   t.is(kip7.isAccessControlRequired({ upgradeable: 'uups' }), true);
//   t.is(kip7.isAccessControlRequired({ upgradeable: 'transparent' }), false);
// });